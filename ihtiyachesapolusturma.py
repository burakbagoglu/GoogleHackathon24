...
button = CTkButton(master=app,text="Soruları Gör",corner_radius=35,fg_color="#528b8b",hover_color="#4158D0",border_color="#FFCC70", border_width=2,)
...
label9= CTkLabel(master=app,text="Cevaplanması zorunlu soruları görmek için aşağıdaki butona tıklayınız.",font=("Arial",15 ))
